...
class Base_Indicate_Group():
    ...
    def rps_top10_order(data, rank):
        ...
        df_stock = df_stock.rename_axis('序号').reset_index()
        return df_stock

    @staticmethod
    def rps_stock_track(data, name):
        ...
        for date in data.index:
            ...
            if (name != '') and (name in rps_df.name.values):
