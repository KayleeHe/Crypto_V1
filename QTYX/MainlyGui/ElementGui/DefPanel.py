...
class SubGraphs:
    def __init__(self, parent):
        ...
        self.FlexGridSizer = wx.FlexGridSizer(rows=2, cols=1, vgap=1, hgap=1)
...
class MergePanel(wx.Panel):
    def __init__(self, parent):
        ...
        self.up_figure = self.figure.add_subplot(2, 1, 1)
        self.down_figure = self.figure.add_subplot(2, 1, 2)
