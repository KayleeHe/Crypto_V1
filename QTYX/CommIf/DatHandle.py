...
def day_to_qfq(day_data):
    ...
    day_data.iloc[0, day_data.columns.get_loc('open_fd')] = day_data.iloc[0, day_data.columns.get_loc(CONV['OPEN'])]
    day_data.iloc[0, day_data.columns.get_loc('high_fd')] = day_data.iloc[0, day_data.columns.get_loc(CONV['HIGH'])]
    day_data.iloc[0, day_data.columns.get_loc('low_fd')] = day_data.iloc[0, day_data.columns.get_loc(CONV['LOW'])]
...
def day_to_hfq(day_data):
    ...
    if (day_data.iloc[0][CONV["CLOSE"]] != 0) and (day_data.iloc[0][CONV["OPEN"]] != 0):
